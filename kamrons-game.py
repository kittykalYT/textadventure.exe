...
while (cont):
    if loop == 0:
        ...
        if answer == "no":
            typewriter("That's too bad - Maybe later!")
    ...
    if answer == "no":
        typewriter("Okay, maybe next time!")
        ...
        if answer == "game":
            ...
            if answer == "left":
                ...
                if answer == "climb":
                    ...
                    if answer == "right":
                        typewriter("Sorry, you were hallucinating with all the adrenaline in your body. You calmly fall to your death as the FBI wonders what you were on.")
                        ...
                        if answer == "car":
                            typewriter("You try to break into a car and... fail. The FBI sniper shoots you from their car and then flexes on his fellow FBI agents that he could shoot a moving target from a moving standpoint. In other words, you died.")
                            ...
                            if answer == "stop":
                                typewriter("I guess you can say you were too late to stop him... so yeah. Game over.")
                                   
                            elif answer == "run":
                                typewriter("You successfully run away from the FBI. Now your options to get home present themselves.")
                                ...
                                if answer == "walk":
                                    ...
                                    if answer == "run":
                                        typewriter("You weren't fast enough.")
                                
                                    if answer == "talk":
                                        typewriter("You manage to get some information out of them.")
                                        typewriter("The story goes that your mother is secretly a bank robber. She got caught, and says that she gave you all the money.")
                                        ...
                                        if answer == "mercy":
                                            typewriter("You beg for mercy a lot. And when I mean a lot, I mean A LOT. The FBI finally accepts, but when they ask you a question, you fall down in exhaustion. Now the FBI thinks you are faking and threatens to kill you. Your choices now are to offer them PROOF, or to RUN.")
                                                ...
                                                if answer == "play":
                                                    ...
                                                    if answer == "find":
                                                        ...
                                                        if answer == "play":
                                                            ...
                                                            typewriter("I would like to thank you for playing, because this is one of the winning endings of this game. Thank you, and simply putting it, THE END.")
                                        ...
                                        if answer == "proof":
                                            ...
                                            if answer == "join":
                                                ...
                                                typewriter("We regret to inform you that this story has come to a close, but if you would like to play again and discover all the endings and funny passages, go ahead and type 'yes' down below. Now without further ado, I'm just going to say, THE END, and thank you for playing.")
                                        
                                        else:
                                            typewriter("Looks like you were confused. You stood there like a dummy until nightfall when the FBI left, and then you just stood there for the rest of your life, slowly rotting to a crisp of ash.") 
                                        
                                    else:
                                        typewriter("Looks like you were confused. You spoke nothing or did nothing and the FBI just assumed you guilty and killed you, case closed.")
                                        
                                else:
                                    typewriter("Looks like you were confused. You did nothing for the rest of your life and died of either starvation of old age. I wouldn't know.")
                                        
                            else:
                                typewriter("Looks like you were confused. You did nothing and the FBI ran over you. Game over.")
                                   
                        else:
                            typewriter("Looks like you were confused. The FBI calmly ran over you.")
                                   
                                   
                    else:
                        typewriter("Looks like you were confused. The FBI calmly pushed you off the building as you just stood there.")
                
                
                elif answer == "fight":
                    typewriter("That was probably not a good idea, because the FBI just easily tased you as you ran towards them and took you to your stay at jail that was for at least a couple hundred years.")
        
        
                else:
                    typewriter("Looks like you were confused. You just stood there motionless as the FBI punched you to death.")
        
        
        
            elif answer == "right":
                typewriter("Great choice! Except... not a great choice. It turns out it was a dead end and the FBI caught up to you and killed you on the spot.")
            elif answer == "ur mom":
                ...
                typewriter("Looks like you were confused. You ran straight into a wall in front of you, the FBI caught up to you, and you were never seen again.")
        else:
            if loop == 0:
                typewriter("Okay, maybe next time!")

            if loop == 69:
                typewriter("Thanks for playing the tutorial! Have fun with the actual game, and see you next time!")
